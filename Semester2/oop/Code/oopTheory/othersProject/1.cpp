...
class Booking{
	...
	public:
	 ...
	 string getStatus() { return status; }
		...
		if(this->getStartTime() == b.getStartTime() || this->getEndTime() == b.getEndTime()){
				cout << "At this time, booking already fixed. ";
				return true;
		}
		else{
			return false;
	 ...
	 static void viewMyBookingRequests(int userId){
	 ...
	 static void cancelBooking(int userId){
	...
	static void viewBookingRequests(){
...
class Users{
	...
	public:
	 ...
	 Users(int uid, string uname, string pwd, string r): id(uid), name(uname), password(pwd), role(r) {
	 }
...
class Student: public Users{
	...
	public:
	 ...
	 Student(string dep, string sem,  int uid, string uname, string pwd, string r): Users(uid, uname, pwd, r){
		department = dep;
		semester = sem;
	 }
	 ...
	 static void requestBooking(int userId){
		...
		string line;
		ifstream request(requestBookingFile);
		while(getline(request, line)){
				...
				b1->setBookingID(bid);
				b1->setUserID(uid);
				b1->setFacility(nullptr);
				b1->setStartTime(st);
				b1->setEndTime(et);
				b1->setStatus(sta);
				bool check = booking == b1;
				if(check){
					delete b1;
					return;
				}
	 ...
	 static void viewBookings(int userId){
		Booking::viewMyBookings(userId);
		Booking::viewMyBookingRequests(userId);
	 }
...
class Faculty: public Users{
	...
	public:
	 ...
	 Faculty(string des, string dep, int uid, string uname, string pwd, string r): Users(uid, uname, pwd, r){
		designation = des;
		department = dep;
	 }
...
class Admin: public Users{
	...
	public:
	 ...
	 Admin(string roleDesc, int uid, string uname, string pwd, string r): Users(uid, uname, pwd, r){
	 ...
	 static void addFacility(Facility *f){
		f->addFacility(f);
	 }

	 static void editFacility(){
		Facility f;
		f.editFacility();
	 }

	 static void removeFacility(){
		Facility f;
		f.removeFacility();
	 }

	 static void viewBookingRequests(){
		Booking::viewBookingRequests();
	 }

	 static void approveORrejectBooking(){
		Booking::approveORrejectBooking();
	 }

	 static void generateReports(Report *r){
		if(r != nullptr){
			r->generateReport();
		} else {
...
class System{
    ...
    if(role == "Student" || role == "student"){
        ...
        Student* s = new Student(dep, sem, id, username, password, role);
        ...
        Faculty* f = new Faculty(designation, dep, id, username, password, role);
        ...
        Admin* a = new Admin(roleDes, id, username, password, role);
            ...
            if(login(u, p, r, userId)){
                    ...
                    if(r == "student" || r == "Student"){
                        ...
                        cin >> studentChoice;
                            ...
                            case 2:{
                                // Request booking
                                Student::requestBooking(userId);
                                break;
                            }
                            case 3:{
                                // View my bookings
                                Student::viewBookings(userId);
                                break;
                            }
							case 4:{
                                // Cancel booking
                                Student::cancelBooking(userId);
                                break;
                            }
                            case 5:{
						...
						cin >> facultyChoice;
							...
							case 2:{
                                // Request booking
                                Faculty::requestBooking(userId);
								break;
							}
							case 3:{
								// View my bookings
								Faculty::viewBookings(userId);
								break;
							}
							case 4:{
								// Cancel booking
								Faculty::cancelBooking(userId);
								break;
							}
							case 5:{
								cout << "Logging out..." << endl;
						...
						cin >> adminChoice;
							...
							case 1:{
								...
								// Add facility using static method
								Admin::addFacility(f);
							...
							case 2:{
								// Edit facility using static method
								Admin::editFacility();
								break;
							}
							case 3:{
								// Remove facility using static method
								Admin::removeFacility();
								break;
							}
							case 4:{
								// View booking requests using static method
								Admin::viewBookingRequests();
								break;
							}
							case 5:{
								// Approve/reject booking using static method
								Admin::approveORrejectBooking();
								break;
							}
							case 6:{
								// Generate report
								Report* r = new Report();
								Admin::generateReports(r);
								delete r;
								break;
							}
							case 7:{
